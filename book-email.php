			...
			<div style="box-sizing:border-box;padding:0 40px 20px;">
				<table style="border-collapse:collapse;width:100%;">
					<tbody>
						...
						<tr>
							<td style="padding:15px 0;text-decoration:underline;">room</td>
							<td style="text-align:right;"><?=$room?></td>
						</tr>
						<tr>
							<td style="padding:15px 0;text-decoration:underline;">bed</td>
							<td style="text-align:right;"><?=$bed?></td>
						</tr>
						<tr>
							<td style="padding:15px 0;text-decoration:underline;">departure</td>
